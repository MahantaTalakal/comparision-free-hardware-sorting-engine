...
HD_PWD='D:/CHACKS/comp_free_sort-29-09-24/comp_free_sort.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sorting_engine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sorting_engine.tcl
