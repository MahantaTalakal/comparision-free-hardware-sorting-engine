...
HD_PWD='D:/CHACKS/comp_free_sort-29-09-24/comp_free_sort.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sorting_engine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sorting_engine.tcl -notrace
